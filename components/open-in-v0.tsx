            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <Button
                        ...
                        <Link href={`https://v0.dev/chat?file=app%2Fpreview%2F${category}%2F${block.split('-').pop()}%2Fpage.tsx&repo=KingTroy125%2FLayered-Blocks`} target="_blank" rel="noreferrer">
                            <svg viewBox="0 0 40 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-5 text-current">
