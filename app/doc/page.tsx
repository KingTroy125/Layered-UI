	...
	"registries": {
	  "@layeredUI": "https://layered-blocks.vercel.app/r/{name}.json"
                            ...
                            <div className="space-y-3">
                                ...
                                <p>
                                    Install blocks via the shadcn CLI using the <span className="text-primary">@layeredUI/{'{name}'}</span> syntax.
                                </p>
                            ...
                            <div>
                                ...
                                <div className="mt-12">
                                    ...
                                    <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-4">
                                        <li>Find me a hero from layeredUI registry</li>
                                        <li>Build me a landing page using a hero and features section from layeredUI registry</li>
                                        <li>Build me a pricing page using a pricing, logo cloud, comparator and faqs blocks from layeredUI mist registry</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
